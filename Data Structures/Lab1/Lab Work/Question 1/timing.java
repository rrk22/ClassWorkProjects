    ...
    public static void main(String args[])
   {
	  ...
	  //max int factorial
		  ...
		  while (keepgoing)
		  {
		  	...
		  	BigDecimal dec2 = new BigDecimal(Integer.MAX_VALUE);
	  ...
	  //max long factorial
		  ...
		  while (keepgoing)
		  {
		  	...
		  	BigDecimal dec1 = new BigDecimal(big1);
		  	BigDecimal dec2 = new BigDecimal(Long.MAX_VALUE);
		  	BigDecimal dec3 = new BigDecimal(big2);
	  ...
	  //max float factorial
		  ...
		  System.out.println("Max Float Factorial: " + counter);
	  ...
	  //max float factorial
		  ...
		  while (keepgoing)
		  {
		  	...
		  	BigDecimal dec1 = new BigDecimal(big1);
		  	BigDecimal dec2 = new BigDecimal(Double.MAX_VALUE);
		  	BigDecimal dec3 = new BigDecimal(big2);
		  ...
		  System.out.println("Max Double Factorial: " + counter);
