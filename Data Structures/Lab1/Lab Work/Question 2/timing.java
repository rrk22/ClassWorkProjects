...
final class timing {
    ...
    public static void main(String args[]) {
        ...
        for (int i = 30; i<=44; i++)
        {
		    ...
		    if (i>30)
            {
            	quotient = timer.time()/prev;
            }
              	
	    //    System.out.println( "Daffy: n: " + i + " time: " + timer + " factor: " + quotient);
	        System.out.println(i + " " + timer.time() + " " + quotient);
	        prev = timer.time();
        }
        ...
        for (int i = 30; i<=44; i++)
        {
	     ...
	     //   System.out.println( "Donald: n: " + i + " time: " + timer + " factor: " + quotient);
	     System.out.println(i + " " + timer.time() + " " + quotient);
	        prev = timer.time();
        }
        ...
        for (int n = 1000; n <= 128000; n*=2)
        {
            ...
            if (n>1000)
            {
            	quotient = stopwatch.time()/prev;
            }
          //  System.out.println("Mickey: " + "n: " + n + " " + stopwatch + " factor: " + quotient);
          System.out.println(n + " " + stopwatch.time() + " " + quotient);
            prev = stopwatch.time();
        }
        System.out.println();
        ...
        for (int n = 1000; n <= 128000; n*=2)
        {
         ...
         //   System.out.println("Minnie: " + "n: " + n + " " + stopwatch + " factor: " + quotient);
         System.out.println(n + " " + stopwatch.time() + " " + quotient);
            prev = stopwatch.time();
        }
        System.out.println();
		...
		//	System.out.println("Goofy: " + "n: " + n + " " + stopwatch + " factor: " + quotient);
			System.out.println(n + " " + stopwatch.time() + " " + quotient);
			prev = stopwatch.time();
        }
        System.out.println();
        ...
        for (int n = 1000; n <= 128000; n*=2)
        {
          ...
          //System.out.println("Pluto: " + "n: " + n + " " + stopwatch + " factor: " + quotient);
          	System.out.println(n + " " + stopwatch.time() + " " + quotient);
            prev = stopwatch.time();
        }
        ...
        for (int n = 1000; n <= 128000; n*=2)
        {
          ...
          //  System.out.println("Gyro: " + "n: " + n + " " + stopwatch + " factor: " + quotient);
            System.out.println(n + " " + stopwatch.time() + " " + quotient);
            prev = stopwatch.time();
        }
        System.out.println();
        ...
        //    System.out.println("BigInteger: " + "n: " + n + " " + stopwatch + " factor: " + quotient);
        	System.out.println(n + " " + stopwatch.time() + " " + quotient);
            prev = stopwatch.time();
        }
   }
